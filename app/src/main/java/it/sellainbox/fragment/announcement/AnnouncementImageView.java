...
public class AnnouncementImageView extends ImageView {
    ...
    public AnnouncementImageView(Context context) {
        this(context, null);
    }

    public AnnouncementImageView(Context context, AttributeSet attrs) {
